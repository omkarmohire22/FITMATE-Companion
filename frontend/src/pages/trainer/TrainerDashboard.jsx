...
const TrainerDashboard = () => {
    ...
    const loadDashboardData = async () => {
      try {
        ...
        const activities = traineesData.slice(0, 4).map((t, idx) => ({
          ...
          color: ['text-blue-500', 'text-green-500', 'text-purple-500', 'text-orange-500'][idx % 4],
          bgColor: ['bg-blue-100', 'bg-green-100', 'bg-purple-100', 'bg-orange-100'][idx % 4]
        }))
  ...
  const loadScheduleData = async () => {
    try {
      ...
      const res = await trainerDashboardApi.getSchedule();
      setMySchedule(res.data?.schedule || []);
    } catch (err) {
    ...
    try {
      ...
      for (const trainee of trainees) {
        try {
          ...
          progressMap[trainee.id] = res.data;
        } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] sm:text-xs text-primary-600 font-semibold tracking-wider">
                    Trainer Panel
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="hidden md:flex items-center gap-2 bg-gray-100 dark:bg-gray-700 px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <input
                  ...
                  className="bg-transparent outline-none text-xs sm:text-sm w-32 sm:w-40 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
                />
              </div>
                ...
                <AnimatePresence>
                  {showNotifications && (
                    <motion.div
                      ...
                      className="absolute right-0 top-12 w-96 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50"
                    >
                      {/* Header */}
                      ...
                      <div className="max-h-80 overflow-y-auto">
                        {conversations.length === 0 ? (
                          <div className="py-8 text-center">
                            ...
                            <p className="text-gray-400 dark:text-gray-500 text-xs mt-1">Messages will appear here</p>
                          </div>
                        ) : (
        ...
        <div className="lg:hidden flex items-center justify-around px-1 py-2 bg-white/95 dark:bg-gray-800/95 border-t border-gray-200 dark:border-gray-700">
          {navTabs.map((tab) => {
            const Icon = tab.icon
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all duration-200 text-xs ${
                  isActive ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-700/50' : 'text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400'
                }`}
              >
      ...
      <div className="flex pt-[120px] sm:pt-[140px] lg:pt-20">
        {/* Sidebar - Desktop */}
        <aside className={`
          fixed left-0 top-[120px] sm:top-[140px] lg:top-20 h-[calc(100vh-120px)] sm:h-[calc(100vh-140px)] lg:h-[calc(100vh-80px)] w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 overflow-y-auto shadow-sm z-40
        ...
        `}>
          <div className="p-6">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
              <h3 className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">Quick Stats</h3>
              <div className="space-y-3">
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-100 dark:border-blue-700/30">
                ...
                <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-100 dark:border-green-700/30">
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-100 dark:border-purple-700/30">
            ...
            <AnimatePresence mode="wait">
              {activeTab === 'overview' && (
                ...
                >
                  ...
                  >
                    <DashboardCard className="bg-gradient-to-r from-primary-600 via-primary-500 to-secondary-500 p-8 text-white overflow-hidden relative">
                      ...
                      <div className="relative z-10">
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                          <div>
                            ...
                            <h2 className="text-3xl font-bold mb-2">{user?.name || 'Trainer'}</h2>
                            <p className="text-primary-100 text-sm">Here's your training dashboard for {new Date().toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}</p>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 text-center min-w-[100px]">
                              ...
                              <p className="text-xs text-primary-100">Trainees</p>
                            </div>
                            <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 text-center min-w-[100px]">
                              <p className="text-3xl font-bold">{todaySchedule.length}</p>
                              <p className="text-xs text-primary-100">Today's Sessions</p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    {[
                      ...
                      { label: 'Avg Progress', value: `+${dashboardStats.avgProgress}%`, icon: TrendingUp, color: 'from-orange-500 to-orange-600', bgColor: 'bg-orange-50 dark:bg-orange-900/20' }
                    ].map((stat, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`${stat.bgColor} rounded-xl p-5 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all`}
                        >
                        ...
                        {[
                          ...
                          return (
                            <motion.button
                              ...
                              className="group p-4 bg-gray-50 dark:bg-gray-700/50 hover:bg-white dark:hover:bg-gray-700 rounded-xl transition-all border border-gray-200 dark:border-gray-600 hover:border-primary-400 dark:hover:border-primary-500 hover:shadow-md"
                            >
                              ...
                              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 text-center">{action.label}</p>
                            </motion.button>
                          );
                        })}
                      </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    >
                      <DashboardCard className="p-6 h-full">
                        <div className="flex items-center justify-between mb-4">
                          <div>
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white">Your Trainees</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-sm">Manage your assigned trainees</p>
                          </div>
                          <button
                            onClick={() => setActiveTab('trainees')}
                            className="text-primary-600 dark:text-primary-400 hover:text-primary-700 text-sm font-medium flex items-center gap-1"
                          >
                          ...
                          {trainees.length === 0 ? (
                            ...
                            trainees.slice(0, 5).map((trainee, index) => (
                              <motion.div
                                ...
                                className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 hover:shadow-sm transition-all border border-gray-200 dark:border-gray-600"
                              >
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <span className={`text-xs px-2 py-0.5 rounded-full ${
                                      trainee.fitness_level === 'beginner' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' :
                        ...
                        <DashboardCard className="p-6">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500 dark:text-gray-400">{new Date().toLocaleDateString('en-US', { weekday: 'long' })}</p>
                            </div>
                          </div>
                          ...
                          <div className="space-y-2">
                            {todaySchedule.length > 0 ? (
                              todaySchedule.map((slot, idx) => (
                                <div key={idx} className={`p-3 rounded-lg border-l-4 ${slot.is_available ? 'bg-green-50 dark:bg-green-900/20 border-l-green-500' : 'bg-orange-50 dark:bg-orange-900/20 border-l-orange-500'}`}>
                                  <p className="font-semibold text-gray-900 dark:text-white text-sm">{slot.start_time} - {slot.end_time}</p>
                                  <p className={`text-xs ${slot.is_available ? 'text-green-600 dark:text-green-400' : 'text-orange-600 dark:text-orange-400'}`}>
                          ...
                          <div className="mb-6">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                              <div className="text-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                                ...
                                <p className="text-xl font-bold text-gray-900 dark:text-white">{dashboardStats.successRate}%</p>
                                <p className="text-xs text-gray-600 dark:text-gray-400">Success</p>
                              </div>
                              <div className="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                <TrendingUp className="w-5 h-5 text-green-500 mx-auto mb-1" />
                                <p className="text-xl font-bold text-gray-900 dark:text-white">+{dashboardStats.avgProgress}%</p>
                              ...
                              <div className="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                ...
                                <p className="text-xl font-bold text-gray-900 dark:text-white">{dashboardStats.totalWorkouts}</p>
              ...
              {activeTab === 'trainees' && (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">Manage Trainees</h3>
                      <p className="text-gray-500 text-sm mt-1">View detailed information about your assigned trainees</p>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 px-3 py-2 rounded-lg">
                        ...
                        <input
                          ...
                          value={searchQuery}
                          onChange={(e) => setSearchQuery(e.target.value)}
                          className="bg-transparent outline-none text-sm w-40 text-gray-900 placeholder-gray-400"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  {trainees.length === 0 ? (
                    <div className="text-center py-16">
                      ...
                      <p className="text-gray-600">No trainees assigned to you yet</p>
                      <p className="text-gray-500 text-sm mt-2">Contact admin to get trainees assigned</p>
                    </div>
                  ) : (
                        ...
                        >
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-gray-500 text-sm truncate">{trainee.email || trainee.user?.email}</p>
                              <div className="flex flex-wrap gap-2 mt-2">
                                <span className={`px-2 py-0.5 text-xs rounded-full font-medium ${
                                  trainee.fitness_level === 'beginner' ? 'bg-green-100 text-green-700' :
                                  trainee.fitness_level === 'intermediate' ? 'bg-yellow-100 text-yellow-700' :
                                  trainee.fitness_level === 'advanced' ? 'bg-red-100 text-red-700' :
                          ...
                          <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                            <div className="bg-primary-50 rounded-lg p-2 border border-primary-200">
                              ...
                              <p className="font-bold text-primary-600">{trainee.weight || '--'} kg</p>
                            </div>
                            <div className="bg-green-50 rounded-lg p-2 border border-green-200">
                              <p className="text-xs text-gray-500">Height</p>
                              <p className="font-bold text-green-600">{trainee.height || '--'} cm</p>
                            </div>
                            <div className="bg-purple-50 rounded-lg p-2 border border-purple-200">
                              <p className="text-xs text-gray-500">Target</p>
                              <p className="font-bold text-purple-600">{trainee.target_weight || '--'} kg</p>
                            </div>
                          </div>
                          
                          {trainee.health_conditions && (
                            <div className="mt-3 p-2 bg-yellow-50 border border-yellow-200 rounded-lg">
                              <p className="text-xs text-yellow-700 font-medium">⚠️ Health: {trainee.health_conditions}</p>
                            </div>
                          )}
                          ...
                          <div className="mt-4 flex gap-2">
                            <button
                              ...
                              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:shadow-lg transition-all font-medium text-sm"
                            >
                            ...
                            <Link
                              to={`/trainer/trainee/${trainee.id}`}
                              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-lg hover:shadow-lg transition-all font-medium text-sm"
                            >
                            ...
                            <button
                              onClick={() => {
                                setSelectedConversation({ id: trainee.user_id, name: trainee.name || trainee.user?.name })
                                setActiveTab('messages')
                              }}
                              className="px-4 py-2 border border-purple-300 text-purple-600 rounded-lg hover:bg-purple-50 transition-all font-medium"
                              title="Send Message"
                            >
                              <MessageCircle className="w-4 h-4" />
                            </button>
                  ...
                  <DashboardCard className="p-8">
                    <div className="flex items-center justify-between mb-8">
                      <div>
                        ...
                        <p className="text-gray-500 text-sm">Manage your availability and training sessions</p>
                      </div>
                      <button 
                        onClick={() => {
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-primary-500 to-secondary-500 hover:shadow-lg text-white rounded-lg font-medium transition-all flex items-center gap-2"
                      >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-700">
                        <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">Total Slots</p>
                        <p className="text-3xl font-bold text-blue-700 dark:text-blue-300 mt-1">{mySchedule.length}</p>
                      </div>
                      <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-200 dark:border-green-700">
                        <p className="text-sm text-green-600 dark:text-green-400 font-medium">Available Slots</p>
                        <p className="text-3xl font-bold text-green-700 dark:text-green-300 mt-1">{mySchedule.filter(s => s.is_available).length}</p>
                      </div>
                      <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4 border border-purple-200 dark:border-purple-700">
                        <p className="text-sm text-purple-600 dark:text-purple-400 font-medium">Booked Slots</p>
                        <p className="text-3xl font-bold text-purple-700 dark:text-purple-300 mt-1">{mySchedule.filter(s => !s.is_available).length}</p>
                      </div>
                    </div>
                        ...
                        {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'].map((day, idx) => {
                          ...
                          return (
                            <motion.div 
                              key={day} 
                              whileHover={{ y: -5 }}
                              className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl p-4 border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all"
                            >
                              <h4 className="font-bold text-gray-900 dark:text-white mb-3 text-center border-b border-gray-300 dark:border-gray-500 pb-3">
                                ...
                                {daySchedule.length > 0 ? (
                                  daySchedule.map((slot, sIdx) => (
                                    <motion.div 
                                      ...
                                      className={`p-3 rounded-lg text-xs shadow-sm border-l-4 cursor-pointer group ${
                                        slot.is_available
                                          ? 'bg-green-50 dark:bg-green-900/20 border-l-green-500 hover:bg-green-100 dark:hover:bg-green-900/40'
                                          : 'bg-orange-50 dark:bg-orange-900/20 border-l-orange-500 hover:bg-orange-100 dark:hover:bg-orange-900/40'
                                      }`}
                                    >
                                      <p className="font-bold text-gray-900 dark:text-white">{slot.start_time} - {slot.end_time}</p>
                                      <p className={`text-[10px] mt-1 ${slot.is_available ? 'text-green-600 dark:text-green-400' : 'text-orange-600 dark:text-orange-400'} font-medium`}>
                                        {slot.is_available ? '✓ Available' : '◉ Booked'}
                                      </p>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            <input
                              ...
                              className="w-5 h-5 rounded border-gray-300 text-primary-500 cursor-pointer"
                            />
              ...
              {activeTab === 'analytics' && (
                ...
                >
                  {/* Header */}
                  <DashboardCard className="p-8 bg-gradient-to-r from-primary-500 to-secondary-500 text-white">
                    <h3 className="text-3xl font-bold mb-2">Progress & Analytics</h3>
                    <p className="text-primary-100">Track trainee progress, metrics, and performance insights</p>
                  </DashboardCard>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <motion.div whileHover={{ y: -5 }} className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-900/40 rounded-xl p-6 border border-orange-200 dark:border-orange-700">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs font-semibold text-orange-600 dark:text-orange-400">AVG</span>
                      </div>
                      <p className="text-3xl font-bold text-orange-700 dark:text-orange-300">+{dashboardStats.avgProgress}%</p>
                      <p className="text-sm text-orange-600 dark:text-orange-400 mt-1">Avg Progress</p>
                    </motion.div>
                  </div>
                  ...
                  <DashboardCard className="p-8">
                    <div className="flex items-center justify-between mb-6">
                      <h4 className="text-xl font-bold text-gray-900 dark:text-white">Individual Trainee Progress</h4>
                      <button 
                        onClick={() => loadProgressData()}
                        className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                      >
                        <RefreshCw className={`w-5 h-5 text-gray-600 dark:text-gray-400 ${progressLoading ? 'animate-spin' : ''}`} />
                      </button>
                    </div>
                        ...
                        <table className="w-full">
                          <thead>
                            <tr className="border-b border-gray-200 dark:border-gray-700">
                              <th className="text-left py-4 px-4 font-semibold text-gray-600 dark:text-gray-400">Trainee</th>
                              <th className="text-left py-4 px-4 font-semibold text-gray-600 dark:text-gray-400">Level</th>
                              <th className="text-left py-4 px-4 font-semibold text-gray-600 dark:text-gray-400">Goal</th>
                              <th className="text-left py-4 px-4 font-semibold text-gray-600 dark:text-gray-400">Weight Progress</th>
                              <th className="text-left py-4 px-4 font-semibold text-gray-600 dark:text-gray-400">Status</th>
                              <th className="text-left py-4 px-4 font-semibold text-gray-600 dark:text-gray-400">Action</th>
                            </tr>
                          </thead>
                          <tbody>
                                ...
                                >
                                  <td className="py-4 px-4">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div>
                                        <p className="font-semibold text-gray-900 dark:text-white">{trainee.name || trainee.user?.name}</p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400">{trainee.email || trainee.user?.email}</p>
                                      </div>
                                    </div>
                                  </td>
                                  <td className="py-4 px-4">
                                  ...
                                  <td className="py-4 px-4">
                                    <span className="text-sm font-medium text-gray-900 dark:text-white">{trainee.goal || 'Not Set'}</span>
                                  </td>
                                  <td className="py-4 px-4">
                                    {prog?.weight_progress ? (
                                      <div className="flex items-center gap-2">
                                        <span className="text-sm font-semibold text-gray-900 dark:text-white">{prog.weight_progress.current || trainee.weight || '--'}kg</span>
                                        <ArrowRight className="w-4 h-4 text-gray-400" />
                                        <span className="text-sm font-semibold text-primary-600 dark:text-primary-400">{trainee.target_weight || '--'}kg</span>
                                      </div>
                                    ) : (
                  ...
                  <DashboardCard className="p-8">
                    <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Trainee Compliance & Metrics</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {trainees.length === 0 ? (
                        ...
                        trainees.map((trainee) => (
                          ...
                          >
                            <div className="flex items-start justify-between mb-4">
                              <div>
                                <h5 className="text-lg font-bold text-gray-900 dark:text-white">{trainee.name || trainee.user?.name}</h5>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Trainee ID: {trainee.id}</p>
                              </div>
                              <div className="text-right">
                                <p className="text-3xl font-bold text-primary-600 dark:text-primary-400">--</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Adherence %</p>
                              </div>
                            </div>

                            <div className="space-y-3">
                              <div className="flex items-center gap-2 p-2 rounded-lg bg-white dark:bg-gray-700/50">
                                <Activity className="w-4 h-4 text-primary-600 dark:text-primary-400" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Fitness: <span className="font-semibold capitalize">{trainee.fitness_level || 'Not Set'}</span></span>
                              </div>
                              <div className="flex items-center gap-2 p-2 rounded-lg bg-white dark:bg-gray-700/50">
                                <Target className="w-4 h-4 text-green-600 dark:text-green-400" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Goal: <span className="font-semibold">{trainee.goal || 'Not Set'}</span></span>
                              </div>
                              <div className="flex items-center gap-2 p-2 rounded-lg bg-white dark:bg-gray-700/50">
                                <TrendingUp className="w-4 h-4 text-purple-600 dark:text-purple-400" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Weight: <span className="font-semibold">{trainee.weight || '--'}kg</span></span>
                              </div>
                            </div>
                    ...
                    <div className="border-r border-gray-200 overflow-y-auto bg-gray-50">
                      ...
                      <div className="p-3 bg-white border-b border-gray-200 sticky top-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <p className="text-xs font-semibold text-gray-700 uppercase">Assigned Trainees</p>
                        </div>
                        <p className="text-[10px] text-gray-500">Direct messaging</p>
                      </div>
                      {trainees.length > 0 ? (
                        trainees.map((trainee) => (
                          <button
                            ...
                            className={`w-full p-3 flex items-center gap-3 hover:bg-white transition-colors border-b border-gray-100 ${
                              selectedConversation?.id === trainee.id && selectedConversation?.isTrainee ? 'bg-green-50 border-l-2 border-l-green-500' : ''
                            }`}
                          >
                            ...
                            <div className="flex-1 text-left min-w-0">
                              <p className="font-medium text-gray-900 truncate">{trainee.name || trainee.user?.name || 'Trainee'}</p>
                              <p className="text-[10px] text-gray-500 truncate">{trainee.email || trainee.user?.email || 'No email'}</p>
                      ...
                      {conversations.length > 0 && (
                        <>
                          <div className="p-3 bg-white border-b border-t border-gray-300 sticky top-[140px]">
                            <div className="flex items-center gap-2 mb-1">
                              <MessageCircle className="w-4 h-4 text-primary-600" />
                              <p className="text-xs font-semibold text-gray-700 uppercase">Other Conversations</p>
                            </div>
                          </div>
                          {conversations.map((conv) => (
                            <button
                              ...
                              className={`w-full p-4 flex items-center gap-3 hover:bg-white transition-colors border-b border-gray-100 ${
                                selectedConversation?.id === conv.user_id && !selectedConversation?.isTrainee ? 'bg-primary-50 border-l-2 border-l-primary-500' : ''
                              }`}
                            >
                      ...
                      {contacts.filter(c => !conversations.find(conv => conv.user_id === c.id)).length > 0 && (
                        <div className="p-3 bg-white border-t border-gray-300">
                          <p className="text-xs text-gray-600 font-semibold mb-2">💬 Start New Conversation</p>
                          {contacts.filter(c => !conversations.find(conv => conv.user_id === c.id)).map((contact) => (
                            ...
                            >
                              <div className="w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center text-gray-700 font-bold text-xs flex-shrink-0">
                                {contact.name?.charAt(0)}
                              </div>
                              <div className="text-left min-w-0">
                                <p className="font-medium text-gray-700 text-sm truncate">{contact.name}</p>
                                <span className="text-[10px] text-gray-500">{contact.label}</span>
                              </div>
                            </button>
                          ))}
                        </div>
                      ...
                      {selectedConversation ? (
                          ...
                          <div className="p-4 border-b border-gray-200 bg-gray-50">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-500">{selectedConversation.role || selectedConversation.label}</p>
                              </div>
                            </div>
                          </div>
                              ...
                              conversationMessages.map((msg) => (
                                <div key={msg.id} className={`flex ${msg.is_mine ? 'justify-end' : 'justify-start'}`}>
                                  <div className={`max-w-[70%] p-3 rounded-2xl ${
                                    ...
                                    <p className={`text-[10px] mt-1 ${msg.is_mine ? 'text-primary-100' : 'text-gray-400'}`}>
                          ...
                          <div className="p-4 border-t border-gray-200 bg-white">
                            <div className="flex items-center gap-2">
                              <input
                                ...
                                className="flex-1 px-4 py-3 border border-gray-200 bg-gray-50 text-gray-900 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500"
                              />
                              <button
                        ...
                        <div className="flex-1 flex items-center justify-center text-gray-500 bg-gray-50">
                          <div className="text-center">
                            ...
                            <p className="text-sm text-gray-500">Choose a trainee or admin to chat with</p>
                          </div>
                        </div>
                      )}
                    </div>
              ...
              {activeTab === 'settings' && (
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.1 }}
                  >
                    <DashboardCard className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 p-6 text-white">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-300 text-sm">Manage your profile, preferences, and account</p>
                        </div>
                      </div>
                    </DashboardCard>
                  </motion.div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <DashboardCard className="p-6">
                          ...
                          <div className="flex items-center gap-4 mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                            ...
                            <div className="flex-1">
                              <h4 className="font-semibold text-gray-900 dark:text-white">{profileForm.name || user?.name || 'Trainer'}</h4>
                              <p className="text-sm text-gray-500 dark:text-gray-400">{user?.email}</p>
                              <span className="inline-flex items-center gap-1 px-2 py-1 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400 text-xs rounded-full mt-2 border border-primary-200 dark:border-primary-800">
                                <Shield className="w-3 h-3" /> Verified Trainer
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 text-gray-900 dark:text-white bg-white dark:bg-gray-700"
                          ...
                          <div className="mt-4">
                            ...
                            <textarea
                              ...
                              className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 text-gray-900 dark:text-white bg-white dark:bg-gray-700 resize-none"
                              placeholder="Tell your trainees about yourself, your training philosophy, and expertise..."
                            />
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{profileForm.bio?.length || 0}/500 characters</p>
                          </div>
                          ...
                          <div className="flex items-center gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
                            <motion.button
                              ...
                              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-xl hover:shadow-lg transition-all font-medium disabled:opacity-50"
                            >
                            ...
                            <button
                              ...
                              className="px-4 py-3 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 font-medium"
                            >
                              Reset
                            </button>
                          </div>
                      ...
                      >
                        <DashboardCard className="p-6">
                          ...
                          <div className="space-y-4">
                            {[
                              { id: 'email_notifications', label: 'Email Notifications', desc: 'Receive updates via email', icon: Mail, enabled: true },
                              { id: 'message_alerts', label: 'Message Alerts', desc: 'Get notified for new messages', icon: MessageCircle, enabled: true },
                              { id: 'trainee_updates', label: 'Trainee Progress Updates', desc: 'When trainees complete workouts', icon: Activity, enabled: true },
                              { id: 'schedule_reminders', label: 'Schedule Reminders', desc: 'Remind upcoming sessions', icon: Calendar, enabled: false }
                            ].map((pref) => {
                              const Icon = pref.icon;
                              return (
                                <div key={pref.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                  <div className="flex items-center gap-3">
                                    <div className="w-9 h-9 rounded-lg bg-gray-200 dark:bg-gray-600 flex items-center justify-center">
                                      <Icon className="w-4 h-4 text-gray-600 dark:text-gray-300" />
                                    </div>
                                    <div>
                                      <p className="font-medium text-gray-900 dark:text-white text-sm">{pref.label}</p>
                      ...
                      >
                        <DashboardCard className="p-6">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="font-bold text-gray-900 dark:text-white">Your Stats</h3>
                          </div>
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center justify-between p-3 bg-primary-50 dark:bg-primary-900/20 rounded-xl">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-gray-700 dark:text-gray-300">Trainees</span>
                              </div>
                              <span className="font-bold text-gray-900 dark:text-white">{dashboardStats.totalTrainees}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-xl">
                              <div className="flex items-center gap-2">
                                <Activity className="w-5 h-5 text-green-500" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Workouts</span>
                              </div>
                              <span className="font-bold text-gray-900 dark:text-white">{dashboardStats.totalWorkouts}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                              ...
                              <span className="font-bold text-gray-900 dark:text-white">{dashboardStats.successRate}%</span>
                            </div>
                        ...
                        <DashboardCard className="p-6">
                          ...
                          <div className="space-y-3 text-sm">
                            <div className="flex justify-between py-2 border-b border-gray-200 dark:border-gray-600">
                              ...
                              <span className="font-medium text-primary-600 dark:text-primary-400">Trainer</span>
                            </div>
                            <div className="flex justify-between py-2 border-b border-gray-200 dark:border-gray-600">
                      ...
                      >
                        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-6">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="font-bold text-red-700 dark:text-red-400">Account Actions</h3>
                          </div>
                          
                          <p className="text-red-600 dark:text-red-400 text-sm mb-4">
                            Need help? Contact the admin for any account-related queries.
                          </p>
                          ...
                          <div className="space-y-2">
                            <motion.button
                              ...
                              whileTap={{ scale: 0.98 }}
                              onClick={logout}
                              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-all font-medium"
                            >
                              <LogOut className="w-4 h-4" />
                              Logout
                            </motion.button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {traineeAnalytics.progress?.weight_progress && (
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-gray-900">{traineeAnalytics.progress.weight_progress.initial?.toFixed(1)}kg</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Current Weight</p>
                        <p className="text-2xl font-bold text-gray-900">{traineeAnalytics.progress.weight_progress.current?.toFixed(1)}kg</p>
                      </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
                  ...
                  {traineeAnalytics.progress?.bodyfat_progress && (
                    <div className="space-y-3">
                      <div>
                        <p className="text-sm text-gray-600">Initial Body Fat</p>
                        <p className="text-2xl font-bold text-gray-900">{traineeAnalytics.progress.bodyfat_progress.initial?.toFixed(1)}%</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Current Body Fat</p>
                        <p className="text-2xl font-bold text-gray-900">{traineeAnalytics.progress.bodyfat_progress.current?.toFixed(1)}%</p>
                      </div>
                      <div className="bg-white rounded-lg p-3 flex items-center gap-2">
                  ...
                  {traineeAnalytics.progress?.compliance && (
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Measurements Logged</span>
                        <span className="font-bold text-gray-900">{traineeAnalytics.progress.compliance.measurement_frequency}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Adherence Rate</span>
                        <span className="font-bold text-gray-900">{traineeAnalytics.progress.compliance.adherence_rate?.toFixed(0)}%</span>
                      </div>
                  ...
                  {traineeAnalytics.progress?.workouts && (
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold text-gray-900">{traineeAnalytics.progress.workouts.total}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Completed</span>
                        <span className="font-bold text-gray-900">{traineeAnalytics.progress.workouts.completed}</span>
                      </div>
