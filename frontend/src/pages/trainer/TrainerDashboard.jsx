  ...
  return (
    <div className="min-h-screen bg-slate-950">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="hidden md:flex items-center gap-2 bg-slate-800/60 px-3 py-2 rounded-lg border border-slate-700/50">
                ...
                <input
                  ...
                  className="bg-transparent outline-none text-xs sm:text-sm w-32 sm:w-40 text-white placeholder:text-slate-400"
                />
              </div>
      ...
      <div className="flex pt-16">
        {/* Sidebar */}
        <aside className={`
          fixed left-0 top-16 h-[calc(100vh-64px)] w-64 bg-slate-900 border-r border-slate-800 overflow-y-auto
            ...
            <div className="p-5 border-b border-slate-800/80">
              ...
              >
                <div className="relative">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-white truncate">{trainerProfile?.name || user?.name || 'Trainer'}</h3>
                  <p className="text-xs text-slate-400 truncate">{user?.email || ''}</p>
                  <div className="flex items-center gap-1.5 mt-1">
                    <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-400 rounded text-[10px] font-semibold border border-emerald-500/30">
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent px-4 py-5">
                    ...
                    return (
                      <motion.button
                        ...
                        className={`
                          ...
                          ${isActive
                            ? 'bg-gradient-to-r from-emerald-500/20 to-teal-500/10 text-white font-semibold border border-emerald-500/30 shadow-lg shadow-emerald-500/5'
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  {/* Total Trainees */}
                  <div className="flex items-center justify-between p-2.5 bg-gradient-to-r from-purple-500/10 to-violet-500/10 rounded-lg border border-purple-500/20">
                    <span className="text-xs text-slate-300 flex items-center gap-1.5">
                      <div className="w-6 h-6 rounded bg-gradient-to-br from-purple-500 to-violet-500 flex items-center justify-center">
        ...
        {/* Main Content Area */}
        <main className="flex-1 lg:ml-64 min-h-screen bg-slate-950 pb-20 lg:pb-0">
            ...
            <AnimatePresence mode="wait">
              {activeTab === 'overview' && (
                ...
                >
                  ...
                  >
                    {[
                      { label: 'Active Trainees', value: dashboardStats.totalTrainees, icon: Users, color: 'from-blue-500 to-blue-600', bgColor: 'bg-blue-900/20' },
                      { label: 'Total Workouts', value: dashboardStats.totalWorkouts, icon: Activity, color: 'from-green-500 to-green-600', bgColor: 'bg-green-900/20' },
                      { label: 'Success Rate', value: `${dashboardStats.successRate}%`, icon: Target, color: 'from-purple-500 to-purple-600', bgColor: 'bg-purple-900/20' },
                      { label: 'Avg Progress', value: `+${dashboardStats.avgProgress}%`, icon: TrendingUp, color: 'from-orange-500 to-orange-600', bgColor: 'bg-orange-900/20' }
                    ].map((stat, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`${stat.bgColor} rounded-xl p-5 border border-slate-700/50 hover:shadow-lg transition-all`}
                        >
                        ...
                        {[
                          ...
                          return (
                            <motion.button
                              ...
                              className="group p-4 bg-slate-800/50 hover:bg-slate-800 rounded-xl transition-all border border-slate-700/50 hover:border-indigo-500/50 hover:shadow-md"
                            >
                              ...
                              <p className="text-sm font-medium text-slate-300 text-center">{action.label}</p>
                            </motion.button>
                          );
                        })}
                      </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    >
                      <DashboardCard className="p-6 h-full">
                        <div className="flex items-center justify-between mb-4">
                          <div>
                            <h3 className="text-lg font-bold text-white">Your Trainees</h3>
                            <p className="text-slate-400 text-sm">Manage your assigned trainees</p>
                          </div>
                          <button
                          ...
                          {trainees.length === 0 ? (
                            ...
                            trainees.slice(0, 5).map((trainee, index) => (
                              <motion.div
                                ...
                                whileHover={{ x: 5 }}
                                className="flex items-center justify-between p-3 rounded-xl bg-slate-800/50 hover:bg-slate-800 hover:shadow-sm transition-all border border-slate-700/50"
                              >
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <span className={`text-xs px-2 py-0.5 rounded-full ${trainee.fitness_level === 'beginner' ? 'bg-green-900/30 text-green-400' :
                                      trainee.fitness_level === 'intermediate' ? 'bg-yellow-900/30 text-yellow-400' :
                                        trainee.fitness_level === 'advanced' ? 'bg-red-900/30 text-red-400' :
              ...
              {activeTab === 'trainees' && (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <DashboardCard className="p-5 bg-gradient-to-br from-blue-900/20 to-blue-900/40 border-blue-700/50">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-blue-400 font-medium">Total Assigned</p>
                          <p className="text-3xl font-bold text-blue-300 mt-1">{trainees.length}</p>
                        </div>
                        <Users className="w-10 h-10 text-blue-500 opacity-50" />
                      </div>
                    </DashboardCard>

                    <DashboardCard className="p-5 bg-gradient-to-br from-green-900/20 to-green-900/40 border-green-700/50">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-green-400 font-medium">Beginners</p>
                    ...
                    <DashboardCard className="p-5 bg-gradient-to-br from-yellow-900/20 to-yellow-900/40 border-yellow-700/50">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-yellow-400 font-medium">Intermediate</p>
                    ...
                    <DashboardCard className="p-5 bg-gradient-to-br from-red-900/20 to-red-900/40 border-red-700/50">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-red-400 font-medium">Advanced</p>
                  ...
                  <DashboardCard className="p-8">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
                      <div>
                        <h3 className="text-2xl font-bold text-white">My Assigned Trainees</h3>
                        <p className="text-slate-400 text-sm mt-1">Personal training clients assigned to you</p>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 bg-slate-800/50 border border-slate-700 px-3 py-2 rounded-lg">
                        ...
                        {trainees
                          ...
                          .map((trainee, idx) => (
                            <motion.div
                              ...
                              className="bg-slate-800/60 border border-slate-700 rounded-xl p-4 sm:p-5 hover:shadow-xl hover:border-indigo-500/50 hover:bg-slate-800/80 transition-all"
                            >
                              <div className="flex items-start gap-3 sm:gap-4">
                                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center shadow-lg flex-shrink-0">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <p className="text-slate-400 text-xs sm:text-sm truncate">{trainee.email || trainee.user?.email}</p>
                                  <div className="flex flex-wrap gap-1.5 sm:gap-2 mt-2">
                                    <span className={`px-2 py-0.5 text-[10px] sm:text-xs rounded-full font-medium ${trainee.fitness_level === 'beginner' ? 'bg-green-900/50 text-green-400 border border-green-700' :
                                    ...
                                    {trainee.goal && (
                                      <span className="px-2 py-0.5 text-[10px] sm:text-xs rounded-full bg-purple-900/50 text-purple-400 border border-purple-700">
                                        {trainee.goal}
                                      </span>
                                    )}
                                  </div>
                              ...
                              <div className="mt-3 sm:mt-4 grid grid-cols-3 gap-2 text-center">
                                <div className="bg-slate-900/60 rounded-lg p-2 border border-slate-700 hover:border-primary-600 transition-colors">
                                  <p className="text-[10px] sm:text-xs text-slate-500">Weight</p>
                                  <p className="font-bold text-sm sm:text-base text-primary-400">{trainee.weight || '--'}</p>
                                  <p className="text-[9px] text-slate-600">kg</p>
                                </div>
                                <div className="bg-slate-900/60 rounded-lg p-2 border border-slate-700 hover:border-green-600 transition-colors">
                                  <p className="text-[10px] sm:text-xs text-slate-500">Height</p>
                                  <p className="font-bold text-sm sm:text-base text-green-400">{trainee.height || '--'}</p>
                                  <p className="text-[9px] text-slate-600">cm</p>
                                </div>
                                <div className="bg-slate-900/60 rounded-lg p-2 border border-slate-700 hover:border-purple-600 transition-colors">
                                  <p className="text-[10px] sm:text-xs text-slate-500">Target</p>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <motion.div
                      ...
                      transition={{ delay: 0.1 }}
                      whileHover={{ y: -3 }}
                      className="bg-gradient-to-br from-slate-800/80 to-slate-900 rounded-xl p-5 border border-slate-700/50 shadow-lg"
                    >
                      <div className="flex items-center justify-between mb-3">
                      ...
                      <p className="text-3xl font-bold text-white">{mySchedule.length}</p>
                      <p className="text-sm text-slate-400 mt-1">Time Slots</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="text-3xl font-bold text-white">{mySchedule.filter(s => s.is_available).length}</p>
                    ...
                    >
                      ...
                      <p className="text-3xl font-bold text-white">{mySchedule.filter(s => !s.is_available).length}</p>
                      <p className="text-sm text-slate-400 mt-1">Booked</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="text-3xl font-bold text-white">{assignedSchedules.length}</p>
                      <p className="text-sm text-slate-400 mt-1">Assigned</p>
                    </motion.div>
                  </div>
                                  ...
                                  daySchedule.map((slot, sIdx) => {
                                    ...
                                    return (
                                      <motion.div
                                        key={sIdx}
                                        whileHover={{ scale: 1.02 }}
                                        className={`p-3 rounded-lg cursor-pointer group relative overflow-hidden ${assigned
                                          ? 'bg-gradient-to-r from-purple-900/60 to-purple-800/40 border border-purple-500/40'
                                          : slot.is_available
                                            ? 'bg-gradient-to-r from-emerald-900/60 to-emerald-800/40 border border-emerald-500/40'
                                            : 'bg-gradient-to-r from-amber-900/60 to-amber-800/40 border border-amber-500/40'
                                        }`}
                                      >
                                        {/* Time */}
                                        <div className="flex items-center justify-between mb-1.5">
                                          ...
                                          <span className="text-sm font-bold text-white">{slot.end_time}</span>
                                        </div>
                                        ...
                                        {assigned ? (
                                          <div className="flex items-center gap-1.5">
                                            ...
                                            <p className="text-purple-300 font-medium text-xs truncate flex-1">
                                              {assigned.trainee?.name}
                                            </p>
                                          </div>
                                        ) : (
                                          <p className={`text-xs font-medium ${slot.is_available ? 'text-emerald-400' : 'text-amber-400'}`}>
                                            {slot.is_available ? '✓ Available' : '◉ Booked'}
                                          </p>
                                        )}
                                        
                                        {/* Hover Actions */}
                                        <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-all">
                                          <button
                                            onClick={() => {
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {assignedSchedules.map((session, idx) => (
                          <motion.div
                            ...
                            transition={{ delay: idx * 0.05 }}
                            whileHover={{ y: -3 }}
                            className="bg-gradient-to-br from-purple-900/40 to-slate-800/80 rounded-xl p-5 border border-purple-500/30"
                          >
                            <div className="flex items-start justify-between mb-4">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <h5 className="font-bold text-white">{session.trainee?.name || 'Unknown'}</h5>
                                  <p className="text-xs text-slate-400">{session.trainee?.email}</p>
                                </div>
                              </div>
                              <button
                                onClick={() => handleUnassignTrainee(session.id)}
                            ...
                            <div className="space-y-2">
                              <div className="flex items-center gap-2 text-sm">
                                ...
                                <span className="text-white font-medium">{session.day_name}</span>
                              </div>
                              <div className="flex items-center gap-2 text-sm">
                                <Clock className="w-4 h-4 text-purple-400" />
                                <span className="text-slate-300">{session.start_time} - {session.end_time}</span>
                              </div>
                              ...
                              {session.notes && (
                                <p className="text-xs text-slate-400 mt-2 p-2 bg-slate-800/50 rounded-lg">
                                  📝 {session.notes}
                                </p>
                              )}
                            </div>
              ...
              {activeTab === 'analytics' && (
                ...
                >
                  ...
                  {/* Key Metrics */}
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <motion.div whileHover={{ y: -5 }} className="bg-gradient-to-br from-blue-900/20 to-blue-900/40 rounded-xl p-6 border border-blue-700/50">
                      <div className="flex items-center justify-between mb-2">
                        <Users className="w-6 h-6 text-blue-400" />
                        <span className="text-xs font-semibold text-blue-400">TOTAL</span>
                      </div>
                      <p className="text-3xl font-bold text-blue-300">{dashboardStats.totalTrainees}</p>
                      <p className="text-sm text-blue-400 mt-1">Assigned Trainees</p>
                    </motion.div>

                    <motion.div whileHover={{ y: -5 }} className="bg-gradient-to-br from-green-900/20 to-green-900/40 rounded-xl p-6 border border-green-700/50">
                      <div className="flex items-center justify-between mb-2">
                        <Activity className="w-6 h-6 text-green-400" />
                        <span className="text-xs font-semibold text-green-400">TOTAL</span>
                      </div>
                      <p className="text-3xl font-bold text-green-300">{dashboardStats.totalWorkouts}</p>
                      <p className="text-sm text-green-400 mt-1">Workouts Completed</p>
                    </motion.div>

                    <motion.div whileHover={{ y: -5 }} className="bg-gradient-to-br from-purple-900/20 to-purple-900/40 rounded-xl p-6 border border-purple-700/50">
                      <div className="flex items-center justify-between mb-2">
                        <Target className="w-6 h-6 text-purple-400" />
                        <span className="text-xs font-semibold text-purple-400">AVG</span>
                      </div>
                      <p className="text-3xl font-bold text-purple-300">{dashboardStats.successRate}%</p>
                      <p className="text-sm text-purple-400 mt-1">Success Rate</p>
                    </motion.div>

                    <motion.div whileHover={{ y: -5 }} className="bg-gradient-to-br from-orange-900/20 to-orange-900/40 rounded-xl p-6 border border-orange-700/50">
                      <div className="flex items-center justify-between mb-2">
                        <TrendingUp className="w-6 h-6 text-orange-400" />
                        <span className="text-xs font-semibold text-orange-400">AVG</span>
                      </div>
                      <p className="text-3xl font-bold text-orange-300">+{dashboardStats.avgProgress}%</p>
                      <p className="text-sm text-orange-400 mt-1">Avg Progress</p>
                    </motion.div>
                  </div>
                        ...
                        <table className="w-full">
                          <thead>
                            <tr className="border-b border-slate-700/50">
                              <th className="text-left py-4 px-4 font-semibold text-slate-400">Trainee</th>
                              <th className="text-left py-4 px-4 font-semibold text-slate-400">Level</th>
                              <th className="text-left py-4 px-4 font-semibold text-slate-400">Goal</th>
                              <th className="text-left py-4 px-4 font-semibold text-slate-400">Weight Progress</th>
                              <th className="text-left py-4 px-4 font-semibold text-slate-400">Status</th>
                              <th className="text-left py-4 px-4 font-semibold text-slate-400">Action</th>
                            </tr>
                          </thead>
                          <tbody>
                                ...
                                >
                                  <td className="py-4 px-4">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div>
                                        <p className="font-semibold text-white">{trainee.name || trainee.user?.name}</p>
                                        <p className="text-xs text-slate-400">{trainee.email || trainee.user?.email}</p>
                                      </div>
                                    </div>
                                  </td>
                                  <td className="py-4 px-4">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2">
                      <DashboardCard className="p-6 dark:bg-slate-900 bg-white dark:border-slate-700 border-gray-200 shadow-lg">
                        {/* Profile Avatar */}
                        <div className="flex items-center gap-4 mb-6 pb-6 border-b dark:border-slate-700 border-gray-200">
                          ...
                          <div>
                            <h3 className="font-bold dark:text-white text-gray-900 text-lg">{profileForm.name || user?.name || 'Trainer'}</h3>
                            <p className="text-sm dark:text-slate-400 text-gray-500">{user?.email}</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <label className="block text-sm font-medium dark:text-slate-300 text-gray-700 mb-1.5">Full Name</label>
                            <input
                              type="text"
                              value={profileForm.name}
                              onChange={(e) => setProfileForm({ ...profileForm, name: e.target.value })}
                              className="w-full px-4 py-2.5 border dark:border-slate-700 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:text-white text-gray-900 dark:bg-slate-800 bg-white"
                              placeholder="Your name"
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium dark:text-slate-300 text-gray-700 mb-1.5">Phone</label>
                            <input
                              type="tel"
                          ...
                          <div>
                            <label className="block text-sm font-medium dark:text-slate-300 text-gray-700 mb-1.5">Specialization</label>
                            <select
                          ...
                          <div>
                            <label className="block text-sm font-medium dark:text-slate-300 text-gray-700 mb-1.5">Experience (Years)</label>
                            <input
                              type="number"
                              min="0"
                              max="50"
                          ...
                          <div className="md:col-span-2">
                            <label className="block text-sm font-medium dark:text-slate-300 text-gray-700 mb-1.5">Certifications</label>
                            <input
                              type="text"
                          ...
                          <div className="md:col-span-2">
                            <label className="block text-sm font-medium dark:text-slate-300 text-gray-700 mb-1.5">Bio</label>
                            <textarea
                              rows={3}
                              maxLength={300}
                              value={profileForm.bio}
                              onChange={(e) => setProfileForm({ ...profileForm, bio: e.target.value })}
                              className="w-full px-4 py-2.5 border dark:border-slate-700 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:text-white text-gray-900 dark:bg-slate-800 bg-white resize-none"
                              placeholder="Brief description about yourself..."
                            />
                            <p className="text-xs dark:text-slate-500 text-gray-400 mt-1 text-right">{profileForm.bio?.length || 0}/300</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 mt-6 pt-4 border-t dark:border-slate-700 border-gray-200">
                          ...
                          <button
                            ...
                            className="px-4 py-2.5 dark:bg-slate-800 bg-gray-100 dark:text-slate-300 text-gray-600 rounded-lg hover:opacity-80 transition-all"
                          >
                            Reset
                          </button>
                        </div>
                    ...
                    <div className="space-y-6">
                      <DashboardCard className="p-5 dark:bg-slate-900 bg-white dark:border-slate-700 border-gray-200 shadow-lg">
                      ...
                      <DashboardCard className="p-5 dark:bg-slate-900 bg-white dark:border-slate-700 border-gray-200 shadow-lg">
                        ...
                        <p className="text-sm dark:text-slate-400 text-gray-500 break-all">{user?.email}</p>
                        <p className="text-xs dark:text-slate-500 text-gray-400 mt-2 flex items-center gap-1">
      ...
      {showAnalyticsModal && selectedTrainee && traineeAnalytics && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4">
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col"
          >
            {/* Header - Sticky */}
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5">
                {/* Weight Progress */}
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-xl p-4 sm:p-5 border border-blue-200 dark:border-blue-800 shadow-sm">
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-white/70 dark:bg-slate-800/50 rounded-lg p-3">
                          <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Initial Weight</p>
                          <p className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">{traineeAnalytics.progress.weight_progress.initial?.toFixed(1)}<span className="text-sm text-slate-500">kg</span></p>
                        </div>
                        <div className="bg-white/70 dark:bg-slate-800/50 rounded-lg p-3">
                          <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Current Weight</p>
                          <p className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">{traineeAnalytics.progress.weight_progress.current?.toFixed(1)}<span className="text-sm text-slate-500">kg</span></p>
                        </div>
                      </div>
                      <div className="bg-white dark:bg-slate-800 rounded-lg p-3 flex items-center justify-between shadow-sm">
                        <span className="text-sm text-slate-600 dark:text-slate-400 font-medium">Change</span>
                        <div className="flex items-center gap-2">
                ...
                {/* Body Fat Progress */}
                <div className="bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-900/30 dark:to-green-900/30 rounded-xl p-4 sm:p-5 border border-emerald-200 dark:border-emerald-800 shadow-sm">
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-3 sm:mb-4 flex items-center gap-2">
                  ...
                  {traineeAnalytics.progress?.bodyfat_progress ? (
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-white/70 dark:bg-slate-800/50 rounded-lg p-3">
                          <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Initial Body Fat</p>
                          <p className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">{traineeAnalytics.progress.bodyfat_progress.initial?.toFixed(1)}<span className="text-sm text-slate-500">%</span></p>
                        </div>
                        <div className="bg-white/70 dark:bg-slate-800/50 rounded-lg p-3">
                          <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Current Body Fat</p>
                          <p className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">{traineeAnalytics.progress.bodyfat_progress.current?.toFixed(1)}<span className="text-sm text-slate-500">%</span></p>
                        </div>
                      </div>
                      <div className="bg-white dark:bg-slate-800 rounded-lg p-3 flex items-center justify-between shadow-sm">
                        <span className="text-sm text-slate-600 dark:text-slate-400 font-medium">Change</span>
                ...
                {traineeAnalytics.milestones?.achievements?.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {traineeAnalytics.milestones.achievements.map((achievement, idx) => (
                      <div 
                        key={idx} 
                        className={`rounded-lg p-3 sm:p-4 flex items-start gap-3 transition-all ${
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-md border-t border-slate-800 shadow-lg">
