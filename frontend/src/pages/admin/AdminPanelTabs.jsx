  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-indigo-600">Admin Panel</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            {!editMode && (
              <button 
                className="px-4 py-2 bg-indigo-500 text-white rounded-lg font-semibold text-sm hover:bg-orange-600 transition-colors" 
                ...
                <div>
                  ...
                  <input 
                    className={`w-full border rounded-lg px-4 py-3 transition-all ${
                      editMode 
                        ? 'border-orange-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500' 
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 pr-10 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
              ...
              {notifications.map((n, idx) => (
                <li key={idx} className="p-3 bg-gray-50 rounded-lg border border-gray-100">
                  <span className={`font-medium text-sm ${
                    n.type === 'payment' ? 'text-indigo-600' : 
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              <button
                className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-indigo-500 to-blue-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all"
