    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div>
          ...
          <p className="text-gray-300 text-base mt-2 font-medium">Manage all admin, trainer, and trainee accounts</p>
        </div>
        <button className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="bg-gradient-to-br from-red-500 to-red-600 rounded-2xl shadow-xl p-4 text-white">
          <p className="text-xs text-red-100 font-medium">Admins</p>
          <p className="text-2xl font-bold mt-1">{adminCount}</p>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-xl p-4 text-white">
          <p className="text-xs text-blue-100 font-medium">Trainers</p>
          <p className="text-2xl font-bold mt-1">{trainerCount}</p>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl shadow-xl p-4 text-white">
          <p className="text-xs text-emerald-100 font-medium">Trainees</p>
          <p className="text-2xl font-bold mt-1">{traineeCount}</p>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-xl p-4 text-white">
          <p className="text-xs text-green-100 font-medium">Active</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
          >
          ...
          <button onClick={loadUsers} className="p-3 bg-gray-800 border border-gray-700 rounded-xl text-white hover:bg-gray-700 transition-all">
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-700/50 border-b border-gray-700">
              <tr>
                ...
                <th className="py-4 px-6 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">User</th>
                <th className="py-4 px-6 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">Role</th>
                <th className="py-4 px-6 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">Status</th>
                <th className="py-4 px-6 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">Joined</th>
      ...
      <AnimatePresence>
        {expandedUser && (
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-xl p-6 border border-gray-700"
          >
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  {users.find(u => u.id === expandedUser)?.phone && (
                    <div>
                      <label className="text-xs text-gray-400 font-semibold uppercase">Phone</label>
                      <p className="text-white mt-1 flex items-center gap-2">
                  ...
                  <div>
                    <label className="text-xs text-gray-400 font-semibold uppercase">Role</label>
